...
const events = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: '3:30 PM', title: 'Boat Regatta @Causeway from Central Church' },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '12:00 PM', title: 'Scavenger Hunt @Causeway from Central Church' },
      { time: 'TBA', title: 'Forest Walk (Short/Long) @China Community Forest' },
    ],
  },
];
